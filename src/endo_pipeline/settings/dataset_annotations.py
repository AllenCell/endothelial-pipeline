"""Constants related to dataset annotations."""

REPRESENTATIVE_ANNOTATION_POSITION: int = 0
"""Representative position for dataset annotations."""

REPRESENTATIVE_ANNOTATION_TIMEPOINT: int = 0
