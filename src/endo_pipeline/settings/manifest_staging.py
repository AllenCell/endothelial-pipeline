...
STAGING_DATAFRAME_MANIFEST_NAMES = [
    ...
    "drift_fixed_points_grid_based_polar_r_polar_theta_rho",
    "drift_fixed_points_grid_based_polar_r_rho",
    "drift_fixed_points_grid_based_polar_theta",
    "drift_vector_field_grid_based_polar_r_polar_theta_rho",
    "drift_vector_field_grid_based_polar_r_rho",
    "drift_vector_field_grid_based_polar_theta",
