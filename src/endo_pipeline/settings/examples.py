...
MODEL_QC_EXAMPLES: list[ExampleImage] = [
    ...
    ExampleImage(
        ...
        description="8. PARALLEL, middle of med flow, puncta location",
    ),
    ExampleImage(
        ...
        description="9. PERPENDICULAR, middle of max flow",
    ),
    ExampleImage(
        dataset_name="20250611_20X",
        position=0,
    ...
    ExampleImage(
        ...
        description="11. PERPENDICULAR / DIAG, middle of no flow",
    ),
    ExampleImage(
