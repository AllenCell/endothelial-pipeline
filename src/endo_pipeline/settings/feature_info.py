...
LABEL_MAP_GRID = {
    ...
    **{
    ...
    "optical_flow_mean_unit_vector_fast_dt1": "Coherent Migration Fast (speed > threshold)",
    "speed_above_1_count_dt1": "N Pixels with Speed Above Threshold",
    "ema005_optical_flow_mean_unit_vector_dt1": "Coherent Migration (EMA 0.05, Optical Flow Mean Unit Vector)",
    "ema005_optical_flow_mean_unit_vector_fast_dt1": "Coherent Migration (EMA 0.05, Optical Flow Mean Unit Vector Fast)",
    "ema01_optical_flow_mean_unit_vector_dt1": "Coherent Migration (EMA 0.1, Optical Flow Mean Unit Vector)",
    "ema01_optical_flow_mean_unit_vector_fast_dt1": "Coherent Migration (EMA 0.1, Optical Flow Mean Unit Vector Fast)",
    "ema02_optical_flow_mean_unit_vector_dt1": "Coherent Migration (EMA 0.2, Optical Flow Mean Unit Vector)",
    "ema02_optical_flow_mean_unit_vector_fast_dt1": "Coherent Migration (EMA 0.2, Optical Flow Mean Unit Vector Fast)",
    "ema01_optical_flow_radial_coherence_dt1": "Radial Coherence (EMA 0.1)",
    "ema01_optical_flow_radial_coherence_weighted_dt1": "Radial Coherence Weighted (EMA 0.1)",
    "optical_flow_radial_coherence_dt1": "Radial Coherence",
    "optical_flow_radial_coherence_weighted_dt1": "Radial Coherence (distance-weighted)",
}
...
RANGE_MAP = {
    ...
    "optical_flow_mean_unit_vector_fast_dt1": (0, 1),
    "ema01_optical_flow_mean_unit_vector_dt1": (0, 1),
    "ema01_optical_flow_mean_unit_vector_fast_dt1": (0, 1),
    "ema02_optical_flow_mean_unit_vector_dt1": (0, 1),
    "ema02_optical_flow_mean_unit_vector_fast_dt1": (0, 1),
}
