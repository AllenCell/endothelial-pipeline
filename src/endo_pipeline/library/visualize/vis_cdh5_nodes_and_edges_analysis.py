...
def generate_alignment_summary_plots(
    df_ang_dist_summary: pd.DataFrame,
    out_dir: Path,
    SHOW_PLOTS: bool,
    SAVE_OUTPUT: bool,
):
    fig, ax = plt.subplots()
    sns.scatterplot(
        data=df_ang_dist_summary,
        x="node_to_node_distance_mean",
        y="angle_relative_to_horizontal_in_deg_mean",
        marker=".",
        hue="Time (hours)",
    ...
    ax.plot(
        df_ang_dist_summary["node_to_node_distance_mean"],
        df_ang_dist_summary["angle_relative_to_horizontal_in_deg_mean"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
    ...
    sns.scatterplot(
        data=df_ang_dist_summary,
        x="node_to_node_distance_std",
        y="angle_relative_to_horizontal_in_deg_std",
        marker=".",
        hue="Time (hours)",
        palette=plt.get_cmap("turbo"),
        legend=True,
    ...
    ax.plot(
        df_ang_dist_summary["node_to_node_distance_std"],
        df_ang_dist_summary["angle_relative_to_horizontal_in_deg_std"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
    ...
    ax.plot(
        df_ang_dist_summary["Time (hours)"],
        df_ang_dist_summary["node_to_node_distance_mean"],
        lw=1,
        c="lightgrey",
        zorder=1,
    ...
    ax2.set_ylabel(
        "Mean angle relative to horizontal (degrees)",
        rotation=270,
    ...
    ax.plot(
        df_ang_dist_summary["Time (hours)"],
        df_ang_dist_summary["edge_length (px)_mean"],
        lw=1,
        c="k",
        alpha=0.5,
        zorder=1,
    ...
    sns.scatterplot(
        data=df_ang_dist_summary,
        x="Time (hours)",
        y="edge_fluorescence_mean (a.u.)_mean",
        marker=".",
        c="k",
        legend=True,
        zorder=10,
    ...
    ax.plot(
        df_ang_dist_summary["Time (hours)"],
        df_ang_dist_summary["edge_fluorescence_mean (a.u.)_mean"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
    ...
    sns.scatterplot(
        data=df_ang_dist_summary,
        x="angle_relative_to_horizontal_in_deg_mean",
        y="edge_fluorescence_mean (a.u.)_mean",
        marker=".",
        hue="Time (hours)",
        palette=plt.get_cmap("turbo"),
...
def compare_metrics_temporal_colorcode(
    df: pd.DataFrame,
    x: str | None = None,
    y: str | None = None,
    semilog=False,
    ...
    if SAVE_OUTPUT:
        assert (
            out_path is not None and filename_stem is not None
        ), "Must provide out_path and filename_stem to save output."
...
def compare_metrics_temporal_colorcode_polar(
    df: pd.DataFrame,
    x: str | None = None,
    y: str | None = None,
    out_path: Path | None = None,
...
def generate_segprop_summary_plots(
    df_segprops_summary: pd.DataFrame, out_dir: Path, SHOW_PLOTS, SAVE_OUTPUT
):
    fig, ax = plt.subplots()
    sns.scatterplot(
        data=df_segprops_summary,
        x="Time (hours)",
        y="cell_orientation_relative_to_horizontal_in_deg_mean",
        marker=".",
        c="tab:blue",
        zorder=10,
        ax=ax,
    ...
    ax.plot(
        df_segprops_summary["Time (hours)"],
        df_segprops_summary["cell_orientation_relative_to_horizontal_in_deg_mean"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
    ...
    ax.plot(
        df_segprops_summary["Time (hours)"],
        df_segprops_summary["cell_area (px**2)_mean"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
    ...
    ax.plot(
        df_segprops_summary["Time (hours)"],
        df_segprops_summary["cell_perimeter (px)_mean"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
    ...
    ax.plot(
        df_segprops_summary["Time (hours)"],
        df_segprops_summary["cell_eccentricity_mean"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
    ...
    sns.scatterplot(
        data=df_segprops_summary,
        x="Time (hours)",
        y="cell_fluorescence_mean (a.u.)_mean",
        marker=".",
        c="tab:blue",
        zorder=10,
        ax=ax,
    ...
    ax.plot(
        df_segprops_summary["Time (hours)"],
        df_segprops_summary["cell_fluorescence_mean (a.u.)_mean"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
    ...
    sns.scatterplot(
        data=df_segprops_summary,
        x="cell_eccentricity_mean",
        y="cell_orientation_relative_to_horizontal_in_deg",
        marker=".",
        hue="Time (hours)",
        palette=plt.get_cmap("turbo"),
        legend=True,
    ...
    ax.plot(
        df_segprops_summary["cell_eccentricity_mean"],
        df_segprops_summary["cell_orientation_relative_to_horizontal_in_deg"],
        lw=1,
        c="lightgrey",
        zorder=1,
    )
