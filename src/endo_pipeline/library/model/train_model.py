...
def _generate_overrides_for_model_training(
    ...
    overrides = {
        ...
        # set the max number of epochs for training based on test_workflow flag
        "trainer.max_epochs": 1 if test_workflow else 1000,
        "trainer.log_every_n_steps": 1 if test_workflow else 50,
    }
    return overrides
...
def initialize_diffae_model(
    ...
    overrides = _generate_overrides_for_model_training(
        model_name, crop_size, train_csv_path, val_csv_path, test_workflow
    )
