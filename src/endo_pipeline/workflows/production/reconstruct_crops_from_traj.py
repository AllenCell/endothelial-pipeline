TAGS = ["diffae_image_generation", "diffae_features", "3d_feature_space"]
...
def main(model_name: str = "diffae_04_10") -> None:
    ...
    model_name
        ...
        Analysis will be performed in the latent space of this model,
        and crop reconstructions will be generated by this model.
