...
def _ddd_model_analysis(
    ...
    """
    from endo_pipeline.library.analyze.diffae_features import model_data_comparison_one_dataset
...
def main(dynamics_config_name: str = "default", model_name: str = "diffae_04_10") -> None:
    ...
    """
    from endo_pipeline.configs import dynamics_io, get_datasets_in_collection, load_model_config
