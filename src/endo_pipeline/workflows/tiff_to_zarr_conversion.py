...
conversion CSV generated by the `tiff-to-zarr-csv` workflow. Make sure to run
that workflow before running this one
...
python3 -m venv tiff_to_zarr_conversion_venv

# activate new environment
source tiff_to_zarr_conversion_venv/bin/activate

# install specific dependencies into new environment
pip install bioio==3.0.0 bioio-ome-tiff==1.4.0 bioio-ome-zarr==3.0.2 \
