...
from src.endo_pipeline.configs import ModelConfig, load_config, load_model_config, save_model_config
from src.endo_pipeline.io import get_output_path

CONFIG_PATH = "../../configs/cyto_dl"
...
def _initialize_diffae_model(
    ...
    overrides = _generate_training_overrides(model_name=model_name, save_path=save_dir)
