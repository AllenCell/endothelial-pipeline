"""
**Supplemental Figure 10**. Changes in rho across the transition from 6 dyn/cm²
to 21 dyn/cm² in imaging data and stable fixed-point values

#supp-figure #fixed-points

| Panel | Description                                                                                |
| ----- | ------------------------------------------------------------------------------------------ |
| A     | Representative images and spatial feature grid for 6, 9, 12, 15, and 21 dyn/cm² replicates |
| B     | Stable fixed point locations for 6, 9, 12, 15, and 21 dyn/cm² replicates                   |
...
```bash
uv run endopipe supp-figure-10-intermediate
```
...
output_path = get_output_path("supp_figure_10_intermediate")
...
build_figure_from_panels(
    panels,
    output_path / "supp_figure_10_intermediate.svg",
