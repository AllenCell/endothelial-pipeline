...
def main(include_panels: UniqueStrList | None = None) -> None:
    ...
    | ----- | ------------------------------------------------------------------------------------------- | ---------- |
    | A     | 3D data-driven vector field for representative low and high shear stress                    |            |
    ...
    | D     | Summary of stable fixed points across low and high shear stress replicates                  |            |
