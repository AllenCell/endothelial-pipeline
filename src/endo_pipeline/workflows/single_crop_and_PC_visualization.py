...
from src.endo_pipeline.library.process import crop_reconstruction_from_data
...
imgs = crop_reconstruction_from_data.get_images_for_crop(df, crop_index, frame_range=frame_range)
...
ax[0].set_title(f"Crop {crop_index}: {position}, ({start_x},{start_y})", fontsize=14)
