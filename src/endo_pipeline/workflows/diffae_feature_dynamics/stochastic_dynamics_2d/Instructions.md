...
`uv run src/endo_pipeline/workflows/diffae_features/stochastic_dynamics_2d/dynamics_preproc.py [config_name]`
...
`uv run src/endo_pipeline/workflows/diffae_features/stochastic_dynamics_2d/dynamics_fit.py [config_name]`
...
`uv run src/endo_pipeline/workflows/diffae_features/stochastic_dynamics_2d/dynamics_summarize.py [config_name]`
