...
logfile="../logs/2d_bf_highFlow.txt"
...
np.save('../outputs/bins_bf_highFlow.npy',np.array(bins,dtype=object),allow_pickle=True)
np.save('../outputs/p_hist_bf_highFlow.npy',p_hist)

## KM average (coarse grained subsampling)
f_KM, a_KM, f_err, a_err = lg.KM_avg_2D(data, bins, stride=stride, dt=dt, multi_traj=True)
np.save('../outputs/KM_drift_bf_highFlow.npy',f_KM)
np.save('../outputs/KM_diff_bf_highFlow.npy',a_KM)
np.save('../outputs/KM_drift_err_bf_highFlow.npy',f_err)
np.save('../outputs/KM_diff_err_bf_highFlow.npy',a_err)
...
coeff_file = '../outputs/coeffs_bf_highFlow.npy'
cost_file = '../outputs/cost_bf_highFlow.npy'
