...
model_dir = Path(r'C:\Users\serge.parent\OneDrive - Allen Institute\Desktop\projects\holistic\cellsmap_labelfree_nuclei_model')
model_path = model_dir / 'bf_std_model_no_preprocess'
