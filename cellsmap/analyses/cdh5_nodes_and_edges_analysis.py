...
def main(N_PROC: int=1, SHOW_PLOTS=True, SAVE_OUTPUT=True, IS_TEST=False):
    ...
    for dataset_name in DATASET_NAME_LIST:
        ...
        data_path_angles_and_dists = PRJ_DIR / f'results/cdh5_nodes_and_edges_analysis/{dataset_name}/{dataset_name}_alignments.csv'
        data_path_segprops = PRJ_DIR / f'results/cdh5_nodes_and_edges_analysis/{dataset_name}/{dataset_name}_segprops.csv'
