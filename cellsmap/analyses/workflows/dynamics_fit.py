...
driftModel = model_fitting.fit_sindy_model(drift_lib,train_test_dict['X_train'],train_test_dict['Y_train'],train_test_dict['u_train'],dt)
...
diffModel = model_fitting.fit_sindy_model(diff_lib,train_test_dict['X_train'],train_test_dict['V_train'],train_test_dict['u_train'],dt)
