...
from cellsmap.analyses.configs.dynamics_viz_config import Nbins_plot, bin_limits, plt_args
...
model_analysis.run_model_analysis_2D(myModel,savedir,PCs,bins,centers,ds_to_skip,plt_args)
