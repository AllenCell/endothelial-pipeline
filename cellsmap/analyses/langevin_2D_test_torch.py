...
import sympy
import fp_solvers_torch as fps
...
logging.basicConfig(filename="logs/2d_highFlow_torch.log", level=logging.INFO, filemode = 'w')
...
np.save('coeffs_highFlow_torch.npy',Xi)
np.save('cost_highFlow_torch.npy',V)
