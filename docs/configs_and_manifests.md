...
from endo_pipeline.manifests import load_model_manifest, get_model_location_for_run
from endo_pipeline.settings.workflow_defaults import LABELFREE_NUCLEI_MODEL_MANIFEST_NAME, LABELFREE_NUCLEI_MODEL_NAME

manifest = load_model_manifest(LABELFREE_NUCLEI_MODEL_MANIFEST_NAME)
location = get_model_location_for_run(manifest, LABELFREE_NUCLEI_MODEL_NAME)
